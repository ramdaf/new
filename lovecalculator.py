...
# *For Love Scores between 40 and 50, the message should be :"Your score is **y**,you are alright together." # Otherwise, the message will just be their score.e.g.:Your Score is **z**."
# EXPL: # name1="Angela Yu" name2="Jack Bauer"
# T occurs 0 times R occurs 1 time # U occurs 2 times E occurs 2 times Total=5 # L occurs 1 time o occurs 0 times V occurs o times E occurs 2 times Total=3
# Love score=53
